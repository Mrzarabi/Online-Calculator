<a href=" {{route('home')}} "><li class="nav-item nav-link ts-scroll custom-font-size float-left site-color" onclick="document.getElementById('sound').play();">HOME</li></a>
...
<a href=" {{route('contactUs')}} "><li class="nav-item nav-link ts-scroll custom-font-size float-left site-color"  onclick="document.getElementById('sound').play();">CONTACT US</li></a>
...
@endif
@guest
<a class="nav-item nav-link ts-scroll custom-font-size float-left site-color" href=" {{route('login')}} " onclick="document.getElementById('sound').play();">LOG IN</a>
    <a class="nav-item nav-link ts-scroll custom-font-size float-left custom-back-signUp" href=" {{route('register')}} "   onclick="document.getElementById('sound').play();">SIGN UP</a>
@else
    <form action=" {{route('logout')}} " method="post" class="float-left">
        @csrf
        <button class="custom-logout-btn" type="submit"><li class="nav-item nav-link ts-scroll custom-font-size site-color" onclick="document.getElementById('sound').play();">LOG OUT</li></button>
    </form>
@endguest