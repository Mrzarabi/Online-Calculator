@if ($paginator->hasPages())
    <nav>
        <ul class="pagination">
            ...
            @else
                <li class="page-item">
                    <a class="page-link custom-page-link" href="{{ $paginator->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">&lsaquo;</a>
                </li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item">
                    <a class="page-link custom-page-link" href="{{ $paginator->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">&rsaquo;</a>
                </li>
            @else
