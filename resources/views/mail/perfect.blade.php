...
@section('content')
    <h2 class="main-h2">[Order Number : {{$order->order_number}}] ({{Carbon\Carbon::parse($order->created_at)->format('d/m/Y') }})</h2>
    <div id="main-div">
        <h4 class="custom-h4">SEND TO US :<strong class="site-color"> {{$order->input_number}} Perfect Money USD</strong></h4>
        ...
        <h2 class="main-h2">Please feel free to contact us if you have any questions</h2>
    </div>
@endsection