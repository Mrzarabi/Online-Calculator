                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-lg-3 col-sm-12 d-flex align-self-center justify-content-center mb-5">
                                    <h6 class="mb-0 text-come text-center site-color mr-3">
                                        {{ isset($max) ? 'MAX: ' . $max : '' }} </h6>
                                    <br>
                                    <h6 class="mb-0 d-block text-come text-center site-color">
                                            ...
                                            <div class="d-flex justify-content-center mw100">
                                                ...
                                                <div class="form-group">
                                                    <input type="number" step="0.01"
                                                        class="form-control form-control-sm mb-2 input-currency-number"
                                                        id="input_number"
                                                        min="{{ isset($input->min) ? $input->min : '' }}"
                                                        max="{{ isset($input->max) ? $input->max : '' }}"
                                                        placeholder="ENTER THE AMOUNT" name="input_number"
                                                        wire:model.lazy="input_number" required>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="form-group">
                                                    <select name="exchange_id"
                                                        class="form-control form-control-sm output-currency-type"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h6 class="mb-0 @if ($image) mt--5 @endif d-block text-come text-center site-color"
                                                style="margin-top: -3rem;"> {{ isset($cost) ? $cost . '%' : '' }} </h6>
                                            <img src="/defaultImages/form-image.png"
                                                class="d-block {{ $image ? 'sold' : '' }}" alt="logo"
                                                width="70">
                                        </div>
                                    </div>
                                </div>
