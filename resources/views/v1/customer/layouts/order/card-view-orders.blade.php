...
<div class="container show-card">
    ...
    @if (count($orders) != 0)
        @foreach ($orders as $order)
                ...
                <div class="d-flex justify-content-center mb-2">
                    ...
                    @if ($order->accept == true)
                        ...
                        @if ($order->feedback)
                            ...
                            <button type="button" class="btns btn-sm ml-1 text-color custom-mobile-font-size p-2" data-toggle="modal" data-target="#mobile-readFeedback-{{$feedback->id}}" data-whatever="@mdo">Reed Feedback</button>
                        @else
            ...
            {{-- modal --}}
                @if (isset($feedback))
                    <div class="modal fade" id="mobile-readFeedback-{{$feedback->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content background-color-modals modal-border">
                                <div class="modal-body">
                                    <div class="form-group">
