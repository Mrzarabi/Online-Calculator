...
@section('content')
    ...
    <div id="main-div">
        <h4 class="custom-h4">SEND TO US :<strong class="custom-h4"> {{$order->input_number}} $ Tether (TRC-20)</strong></h4>
        ...
        <div class="custom-qr-image">
            <img width="400" src="{{ asset('/defaultImages/picture.png') }}" alt="logo">
        </div>
    </div>
