                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-3 col-sm-12">
                                    <h6 class="mb-0 text-come text-center site-color d-flex align-self-center"> {{isset($max) ? 'MAX: '.$max : ''}} </h6>
                                ...
                                <div class="col-md-6 col-sm-12 pr-0 pl-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex justify-content-center mw100">
                                                <div class="form-group">
                                                    <select name="calculator_id" class="form-control form-control-sm input-currency-type" wire:model.lazy="input_currency_type" required>
                                        ...
                                        <div class="col-md-8 offset-md-2 cpr-sm-0" style="padding-left: 0;">
                                            @guest
                                ...
                                <div class="col-md-3 col-sm-12 accent-green p-0 d-flex align-items-center justify-content-sm-center mt-sm">
                                    <div class="row">
                                        <div class="col-md-12">
