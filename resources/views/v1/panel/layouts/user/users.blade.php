                ...
                <div class="col-md-4 mb-4">
                    <div class="custom-card custom-background-card">
                        ...
                        <div class="d-flex justify-content-center mb-2">
                            <button type="button" class="btns pr-3 pl-3 btn-sm text-color mr-1" data-toggle="modal" data-target="#deleteUser-{{$user->id}}" data-whatever="@mdo">DELETE</button>
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('users.destroy', ['user' => $user->id]) }}" method="post">
                                        <div class="modal-body">
                                            @csrf
                                            @method('DELETE')
                                            <h5 class="text-center text-color"> ARE YOU SURE THAT YOU WANT TO DELETE THE USER {{$user->name . ' ' . $user->family}}?</h5>
                                            <div class="mt-3 ml-4 d-flex justify-content-end">
                                                ...
                                                <button type="submit" class="btns text-color pr-4 pl-4 pt-2 pb-2 custom-font-size">YES, DELETE USER</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
