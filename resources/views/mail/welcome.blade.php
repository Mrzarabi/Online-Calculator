...
@section('content')
    ...
    <div id="main-div">
        ...
        <p>Through your client area DASHBOARD. you cheack your order's status all recent and past order's history and more.
        </p>
        <div>
            <h3 class="mb-0">Getting Support</h3>
            <p class="mt-0">If you have any question. try our extensive list of <a href="">Frequently Asked
                    Question Page</a> or contact us via Email/WhatsApp/Telegram/Skype - </p>
        </div>
