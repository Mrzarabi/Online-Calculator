<div>
    ...
    <div class="container h100 p-0">
        <div class="col-md-12 w100 pbc">
                        ...
                        <form action="{{route('customer.forms.send')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    @if ($errors->has('email'))
                                        <span class="d-block text-danger custom-font-size">{{ $errors->first('email') }}</span>
                                    @endif
                                    ...
                                    @if ($errors->has('email_confirmation'))
                                        <span class="d-block text-danger custom-font-size">{{ $errors->first('email_confirmation') }}</span>
                                    @endif
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <h6 class="text-center text-nowrap text-color custom-font-size mb-4 mt-2">Please note PayPal internal fee is not included this amount.</h6>
                                    </div>

                                    <div class="wrap-input2 mb-3 d-flex">
                                        <input class="bg-transparent input2" type="text" name="wallet" wire:model.lazy="wallet" required>
                                        <span class="focus-input2 text-uppercase " data-placeholder="Your {{$this->input->name}} Wallet *"></span>
                                        <img src="/defaultImages/view/form/paypal email.png" alt="wallet" class="float-right pb-3 pt-2" width="18" height="45">
                                    </div>
                                    @if ($errors->has('wallet'))
                                        <span class="d-block text-danger custom-font-size">{{ $errors->first('wallet') }}</span>
                                    @endif
                                    ...
                                    @if ($errors->has('contact_email'))
                                        <span class="d-block text-danger custom-font-size">{{ $errors->first('contact_email') }}</span>
                                    @endif
                                    ...
                                    @if ($errors->has('contact_email_confirmation'))
                                        <span class="d-block text-danger custom-font-size">{{ $errors->first('contact_email_confirmation') }}</span>
                                    @endif
                                ...
                                <div class="col-md-5">
                                    ...
                                    @if ($errors->has('telegram'))
                                        <span class="d-block text-danger custom-font-size">{{ $errors->first('telegram') }}</span>
                                    @endif
                                    ...
                                    @if ($errors->has('whatsApp'))
                                        <span class="d-block text-danger custom-font-size">{{ $errors->first('whatsApp') }}</span>
                                    @endif
                                    ...
                                    @if ($errors->has('skype'))
                                        <span class="d-block text-danger custom-font-size">{{ $errors->first('skype') }}</span>
                                    @endif
                                    ...
                                    @if ($errors->has('extra'))
                                        <span class="d-block text-danger custom-font-size">{{ $errors->first('extra') }}</span>
                                    @endif
                                    ...
                                    @else
                                        ...
                                        <div class="form-group mt-3">
                                            <div class="col-md-6">
                                                ...
                                                <button type="button" class="btn btn-sm rounded custom-btn-content refresh-button">Refresh</button>
