    ...
    <div class="middle w100">
        <div class="h100 p-0">
            <div class="col-md-12 w100 pbc p-0">
                <h6 class="site-color text-center mb-3"> Exchange {{$order->calculator->name}} To {{$order->element->name}} </h6>
                            ...
                            <form action="{{route('customer.forms.send')}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @if ($errors->has('email'))
                                            <span class="d-block text-danger custom-font-size mb-3">{{ $errors->first('email') }}</span>
                                        @endif
    
                                        <div class="wrap-input2 mb-3 d-flex">
                                            <input class="bg-transparent input2" type="email" name="email_confirmation" value=" {{old('email_confirmation')}} " required>
                                            <span class="focus-input2 text-uppercase" data-placeholder="Confirm PayPal E-mail Address *"></span>
                                            <img src="/defaultImages/view/form/paypal email.png" alt="paypal email" class="float-right pb-3 pt-2" width="18" height="45">
                                        </div>
                                        @if ($errors->has('email_confirmation'))
                                            <span class="d-block text-danger custom-font-size mb-3">{{ $errors->first('email_confirmation') }}</span>
                                        @endif
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <h6 class="text-center text-color custom-font-size mb-4 mt-2">Please note PayPal internal fee is not included this amount.</h6>
                                        </div>
    
                                        <div class="wrap-input2 mb-3 d-flex">
                                            <input class="bg-transparent input2" type="text" name="wallet" value=" {{old('wallet')}} " required>
                                            <span class="focus-input2 text-uppercase " data-placeholder="Your {{$order->calculator->name}} Wallet *"></span>
                                            <img src="/defaultImages/view/form/paypal email.png" alt="wallet" class="float-right pb-3 pt-2" width="18" height="45">
                                        </div>
                                        @if ($errors->has('wallet'))
                                            <span class="d-block text-danger custom-font-size mb-3">{{ $errors->first('wallet') }}</span>
                                        @endif
                                        
                                        <div class="wrap-input2 mb-3 d-flex">
                                            <input class="bg-transparent input2" type="email" name="contact_email" value=" {{old('contact_email')}} " required>
                                            <span class="focus-input2 text-uppercase" data-placeholder="Your Contact E-mail Address *"></span>
                                            <img src="/defaultImages/view/form/email.png" alt="email" class="float-right pb-3 pt-3" width="18" height="45">
                                        </div>
                                        @if ($errors->has('contact_email'))
                                            <span class="d-block text-danger custom-font-size mb-3">{{ $errors->first('contact_email') }}</span>
                                        @endif
    
                                        <div class="wrap-input2 mb-3 d-flex">
                                            <input class="bg-transparent input2" type="email" name="contact_email_confirmation" value=" {{old('contact_email_confirmation')}} " required>
                                            <span class="focus-input2 text-uppercase" data-placeholder="Confirm Contact E-mail Address *"></span>
                                            <img src="/defaultImages/view/form/email.png" alt="email" class="float-right pb-3 pt-3" width="18" height="45">
                                        </div>
                                        @if ($errors->has('contact_email_confirmation'))
                                            <span class="d-block text-danger custom-font-size mb-3">{{ $errors->first('contact_email_confirmation') }}</span>
                                        @endif
    
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                <h6 class="text-center text-color custom-font-size mt-2">The transaction will be sent to this email.</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="wrap-input2 mb-3 d-flex">
                                            <input class="bg-transparent input2" type="text" name="telegram" value=" {{old('telegram')}} ">
                                            <span class="focus-input2 text-uppercase" data-placeholder="Telegram"></span>
                                            <img src="/defaultImages/view/form/telegram.png" alt="telegram" class="float-right pb-2 pt-3" width="18" height="40">
                                        </div>
                                        @if ($errors->has('telegram'))
                                            <span class="d-block text-danger custom-font-size mb-3">{{ $errors->first('telegram') }}</span>
                                        @endif
                                        ...
                                        <div class="wrap-input2 mb-3 d-flex">
                                            <input class="bg-transparent input2" type="text" name="skype" value=" {{old('skype')}} ">
                                            <span class="focus-input2 text-uppercase" data-placeholder="Skype"></span>
                                            <img src="/defaultImages/view/form/email.png" alt="skype" class="float-right pb-3 pt-3" width="18" height="45">
                                        </div>
                                        @if ($errors->has('skype'))
                                            <span class="d-block text-danger custom-font-size mb-3">{{ $errors->first('skype') }}</span>
                                        @endif
                                        ...
                                        <div class="wrap-input2 mb-3 d-flex">
                                            <input class="bg-transparent input2" type="text" name="extra" value=" {{old('extra')}} ">
                                            <span class="focus-input2 text-uppercase" data-placeholder="extra"></span>
                                            <img src="/defaultImages/view/form/extra note.png" alt="extra" class="float-right pb-2 pt-3" width="18" height="40">
                                        </div>
                                        @if ($errors->has('extra'))
                                            <span class="d-block text-danger custom-font-size mb-3">{{ $errors->first('extra') }}</span>
                                        @endif
                                        ...
                                        @else
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="cheack" value="{{true}}" id="flexCheckDefault" required>
                                                <label class="form-check-label mt-1 site-color" for="flexCheckDefault">
                                                    I AGREE TO THE  
                                                    <button type="button" class="custom-btn-form-terms border-bottom mr-1" data-toggle="modal" data-target="#show-terms" data-whatever="@mdo">TERMS OF SERVICE</button>
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <button type="button" class="btn btn-sm rounded custom-btn-content refresh-button mt--5">Refresh</button>
                                                    
                                                    <div class="wrap-input2 mt-4 mb-3 d-flex">
                                                        <input class="bg-transparent input2 @error('captcha') is-invalid @enderror" type="text" id="captcha" name="captcha" required>
                                                        <span class="focus-input2 text-uppercase" data-placeholder="Captcha"></span>
                                                        <img src="/defaultImages/view/form/extra note.png" alt="extra" class="float-right pb-2 pt-3" width="18" height="40">
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center mt-4 ml-4">
                                            <a href=" {{route('home')}} " class="btn btn-sm text-color" onclick="document.getElementById('sound').play();">Cancel</a>
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-12 d-flex justify-content-center align-items-center mb-3">
                                                    <div class="rounded p-3 text-justify">
                                                        ...
                                                        <p class="mb-0 mt-3 text-center text-light">If we could accept your refunds, we will take 10% as fine.</p>
                                                        <h6 class="mb-2 mt-2 site-color font-weight-lighter text-center custom-font-size">
                                                            If you are not sure about your PayPal account safety and stability, please do not use our PayPal service.
                                                        </h6>
                                                    </div>
                                                </div>
                                                <button type="button" class="btn site-color mr-2 rounded float-right" data-dismiss="modal"  onclick="document.getElementById('sound').play();">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
