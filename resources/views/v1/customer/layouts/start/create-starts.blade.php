<div class="d-flex justify-content-center mb-5">
    <button type="button" class="btns text-color justify-center custom-font-size pr-3 pl-3 pt-2 pb-2" data-toggle="modal" data-target="#create-starter" data-whatever="@mdo">CREATE NEW SESSION</button>
</div>
{{-- modal --}}
    <div class="modal fade" id="create-starter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
