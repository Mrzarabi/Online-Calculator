                                 ...
                                 <div class="col-lg-8">
                                     <div class="left-aboutus">
                                         <div class="top-left-aboutus with-left-linear-gradient-to-bottom">
                                             <h5 class="text-left site-color pl-3 mb-3">Check Out Our Terms and Conditions
                                             </h5>
                                         ...
                                         <div class="middle-left-aboutus">
                                            ...
                                            Our Major focus now is to help our clients with PayPal & Cash exchanges.
                                             ...
                                             <h6 class="text-justify mt-3 mb-3 cutom-font-size-bold">
                                                 PayPal orders are processed in approximately 1-2 hours. SamxPay send PayPal
                                                 transactions as payments for “Goods and Services”.
                                                 PayPal may charge an additional commission to the recipient when accepting
                                                 funds, which will be deducted from received amount.
                                             </h6>
                                             <h6 class="mt-3 site-color font-weight-lighter custom-font-size">
                                                 Please be careful when you are typing the email address which is linked to
                                                 your PayPal account.
                                             </h6>
                                             <h6 class="mb-3 site-color font-weight-lighter custom-font-size">
                                                 We do not accept any responsibility if the given email address spelling is
                                                 wrong by users.
                                             </h6>
                                             <h6 class="text-justify mt-3 mb-3 cutom-font-size-bold">
                                                 Upon PayPal transaction completion and providing you with transaction ID &
                                                 receipt screenshots, we will not accept any refunds from receiver PayPal
                                                 account.
                                             </h6>
                                             <h6 class="mt-3 site-color font-weight-lighter custom-font-size">
                                                 Please contact us before any refunds and get sure we can accept your
                                                 refunds or not.
                                             </h6>
                                             <h6 class="mb-3 site-color font-weight-lighter custom-font-size">
                                                 We will not responsible for any loss if you do refunds without any further
                                                 notice.
                                             </h6>
                                             ...
                                             <h6 class="text-justify mt-3 mb-3 cutom-font-size-bold">
                                                 If you are not sure about your PayPal account safety and stability, please
                                                 do not use our PayPal service.
                                             </h6>
                                         </div>
                                     </div>
                                 </div>
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-10 offset-md-1 with-linear-gradient ">
                                             ...
                                             <ul class="mt-2">
                                                 <li class="d-flex">
                                                     <span class="mr-2">
                                                         <img src="/defaultImages/6590522_email_envelope_letter_mail_message_icon.png"
                                                             alt="email" width="15">
                                                     </span>
                                                 ...
                                                 <li class="d-flex mb-2">
                                                     <span class="mr-2">
                                                         <img src="/defaultImages/2849827_pointer_map_location_place_multimedia_icon.png"
                                                             alt="location" width="15">
                                                     </span>
                                                 ...
                                                 <li class="d-flex mb-2">
                                                     <span class="mr-2">
                                                         <img src="/defaultImages/2561306_phone_call_icon.png" alt="phone"
                                                             width="15">
                                                     </span>
                                                 ...
                                                 <li class="d-flex mb-2">
                                                     <span class="mr-2">
                                                         <img src="/defaultImages/843786_whatsapp_icon.png" alt="phone"
                                                             width="15">
                                                     </span>
